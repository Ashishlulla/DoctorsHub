...
namespace DoctorsHub.API.Controllers
{
    ...
    public class DashBoardController : ControllerBase
    {
        ...
        [HttpGet("today")]
        public async Task<IActionResult> GetTodaysAppointmentsAsync() 
        {
            List<TodayAppointmentsDto> todayAppointments = await _crmService.GetTodaysAppointmentAsync();

            return Ok(todayAppointments);
        }

        [HttpGet("schedule")]
        public async Task<IActionResult> GetScheduledAppointmentsAsync()
        {
            List<ScheduledAppointmentsDto> scheduledAppointments = await _crmService.GetScheduledAppointmentsAsync();
